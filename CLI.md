...
This folder contains a **minimal reference CLI** for `dsl-core`.
It is a thin adapter over the engine and exists to provide deterministic validation and machine-consumable outputs for CI and tooling.
